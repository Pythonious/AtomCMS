			...
			while($opened = mysqli_fetch_assoc($r)) { ?>
				...
				<form class="form-inline" action="index.php?page=navigation&id=<?php echo $opened['id']; ?>" method="post" role="form">
					...
					<div class="form-group">
						...
						<input class="form-control" type="text" name="url" id="url" value="<?php echo $opened['url']; ?>" placeholder="Value">
					</div>

					<div class="form-group">
						<label class="sr-only" for="position">Position:</label>
						<input class="form-control" type="text" name="position" id="position" value="<?php echo $opened['position']; ?>" placeholder="Value">
					</div>

					<div class="form-group">
						<label class="sr-only" for="status">Status:</label>
						<input class="form-control" type="text" name="status" id="status" value="<?php echo $opened['status']; ?>" placeholder="Value">
					</div>
